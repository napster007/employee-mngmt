import { ComponentType, ReactElement, ElementType, HTMLAttributes, NamedExoticComponent, RefObject, MouseEvent as MouseEvent$1, Dispatch, MutableRefObject, ForwardRefExoticComponent, RefAttributes, FC, ReactNode, KeyboardEvent, Context, Reducer, Component, MemoExoticComponent } from 'react';
...
declare type RowsProp = RowModel[];
/**
 * The key value object representing the data of a row.
 */
interface RowModel extends ObjectWithId {
    [key: string]: any;
}
/**
 ...
 * @returns a boolean
 */
declare function checkRowHasId(rowData: RowModel | Partial<RowModel>, detailErrorMessage?: string): boolean;
...
interface IconsOptions {
     ...
     */
    ColumnFiltered?: ElementType;
    /**
     * Icon displayed on the column menu selector tab.
     */
    ColumnSelector?: ElementType;
    /**
 ...
 * The full grid API.
 */
declare type GridApi = CoreApi & StateApi & DensityApi & EventsApi & RowApi & ColumnApi & ColumnReorderApi & SelectionApi & SortApi & VirtualizationApi & PaginationApi & FilterApi & ColumnMenuApi & ColumnResizeApi & PreferencesPanelApi;
...
declare function ColumnHeaderItemCollection(props: ColumnHeadersItemCollectionProps): JSX.Element;
...
declare function GridColumnHeaderMenu(): JSX.Element | null;
...
declare function FilterInputValue(props: TypeFilterInputValueProps): JSX.Element;
...
declare const RESET_ROWS = "resetRows";
...
declare const allColumnsSelector: OutputSelector<GridState, Columns, (res: InternalColumns) => Columns>;
...
export { AddIcon, Alignement, ApiContext, ApiRef, ArrowDownwardIcon, ArrowUpwardIcon, AutoSizer, AutoSizerProps, AutoSizerSize, CELL_CLICK, CELL_CSS_CLASS, CELL_HOVER, CLICK, COLUMNS_UPDATED, COLUMN_FILTER_BUTTON_CLICK, COLUMN_HEADER_CLICK, COLUMN_HEADER_HOVER, COLUMN_MENU_BUTTON_CLICK, COL_REORDER_DRAG_ENTER, COL_REORDER_DRAG_OVER, COL_REORDER_DRAG_OVER_HEADER, COL_REORDER_START, COL_REORDER_STOP, COL_RESIZE_START, COL_RESIZE_STOP, COMPONENT_ERROR, Cell, CellCheckboxRenderer, CellClassFn, CellClassNamePropType, CellClassParams, CellClassRules, CellIndexCoordinates, CellParams, CellValue, CheckCircleIcon, CloseIcon, ColDef, ColParams, ColType, ColTypeDef, ColumnApi, ColumnHeaderItem, ColumnHeaderItemCollection, ColumnHeaderSeparator, ColumnHeaderSeparatorProps, ColumnHeaderSortIcon, ColumnHeaderSortIconProps, ColumnHeaderTitle, ColumnHeaderTitleProps, ColumnHeadersItemCollectionProps, ColumnIcon, ColumnLookup, ColumnMenuState, ColumnProp, ColumnReorderState, ColumnTypesRecord, Columns, ColumnsHeader, ColumnsMenuItem, ColumnsMeta, ColumnsPanel, ComparatorFn, ComponentProps, ContainerProps, CoreApi, DATA_CONTAINER_CSS_CLASS, DATETIME_COLUMN_TYPE, DATETIME_COL_DEF, DATE_COLUMN_TYPE, DATE_COL_DEF, DEFAULT_COLUMN_TYPES, DEFAULT_COL_TYPE_KEY, DEFAULT_GRID_OPTIONS, DRAGEND, DataGrid, DataGridProps, DebouncedFunction, DefaultFooter, DefaultFooterProps, Density, DensityApi, DensityOption, DensityTypes, DragIcon, EXPERIMENTAL_ENABLED, ElementSize, EventsApi, FILTER_MODEL_CHANGE, FOCUS_OUT, FeatureMode, FeatureModeConstant, FieldComparatorList, FilterAltIcon, FilterColumnLookup, FilterForm, FilterFormProps, FilterInputValue, FilterInputValueProps, FilterItem, FilterItemProps, FilterListIcon, FilterMenuItem, FilterModel, FilterModelState, FilterOperator, FilterPanel, GRID_FOCUS_OUT, GridApi, GridCellProps, GridColumnHeaderMenu, GridColumnsContainer, GridComponent, GridComponentOverridesProp, GridComponentProps, GridDataContainer, GridFooter, GridMenu, GridOptions, GridOptionsProp, GridOverlay, GridRoot, GridState, GridWindow, HEADER_CELL_CSS_CLASS, HEADER_CELL_DRAGGING_CSS_CLASS, HEADER_CELL_DROP_ZONE_CSS_CLASS, HEADER_CELL_SEPARATOR_RESIZABLE_CSS_CLASS, HEADER_CELL_TITLE_CSS_CLASS, HeaderCheckbox, HideColMenuItem, INITIAL_PAGINATION_STATE, IconsOptions, InternalColumns, InternalRenderingState, InternalRowsState, KEYDOWN, KEYUP, KeyboardState, LeftEmptyCell, LinkOperator, LoadIcon, LoadingOverlay, Logger, MOUSE_HOVER, MULTIPLE_KEY_PRESS_CHANGED, MULTIPLE_SELECTION_KEYS, MenuIcon, MenuProps, NUMBER_COLUMN_TYPE, NUMERIC_COL_DEF, NativeColTypes, NoRowMessage, ObjectWithId, PAGESIZE_CHANGED, PAGE_CHANGED, PageChangeParams, Pagination, PaginationActions, PaginationApi, PaginationState, Panel, PanelProps, PreferencePanelState, PreferencePanelsValue, PreferencesPanel, RESET_ROWS, RESIZE, ROWS_UPDATED, ROW_CLICK, ROW_CSS_CLASS, ROW_HOVER, ROW_SELECTED, RenderColumnsProps, RenderContextProps, RenderPaginationProps, RenderRowProps, RenderingZone, RightEmptyCell, RootContainerRef, Row, RowApi, RowCells, RowCount, RowId, RowModel, RowParams, RowProps, RowSelectedParams, RowsLookup, RowsProp, SCROLL, SCROLLING, SCROLLING_START, SCROLLING_STOP, SELECTION_CHANGED, SORT_MODEL_CHANGE, STATE_CHANGE, STRING_COLUMN_TYPE, STRING_COL_DEF, STRING_OPERATORS, ScrollArea, ScrollBarState, ScrollFn, ScrollParams, SearchIcon, SelectedRowCount, SelectionApi, SelectionChangeParams, SelectionState, SeparatorIcon, SortApi, SortColumnLookup, SortDirection, SortItem, SortMenuItems, SortModel, SortModelParams, SortingState, StateApi, StickyContainer, TableRowsIcon, TripleDotsVerticalIcon, TypeFilterInputValueProps, UNMOUNT, ValueFormatterParams, ValueGetterParams, ViewHeadlineIcon, ViewStreamIcon, Viewport, ViewportSizeState, VirtualizationApi, VisibleRowsState, Watermark, WatermarkProps, activeFilterItemsSelector, allColumnsSelector, buildCellParams, buildRowParams, checkRowHasId, checkboxSelectionColDef, classnames, columnLookupSelector, columnMenuStateSelector, columnReorderDragColSelector, columnReorderSelector, columnsMetaSelector, columnsSelector, columnsTotalWidthSelector, containerSizesSelector, convertRowsPropToState, dateComparer, dateFormatter, dateTimeFormatter, filterColumnLookupSelector, filterItemsCounterSelector, filterStateSelector, filterableColumnsSelector, findCellElementsFromCol, findDataContainerFromCurrent, findGridRootFromCurrent, findHeaderElementFromField, findParentElementFromClassName, getCellElementFromIndexes, getColDef, getFieldFromHeaderElem, getIdFromRowElem, getInitialColumnReorderState, getInitialColumnsState, getInitialFilterState, getInitialRenderingState, getInitialRowState, getInitialSortingState, getInitialState, getInitialVisibleRowsState, getPageCount, isArray, isArrowKeys, isCell, isDate, isDesc, isEqual, isFunction, isHeaderTitleContainer, isHomeOrEndKeys, isMultipleKey, isNavigationKey, isNumber, isObject, isOverflown, isPageKeys, isSpaceKey, isString, isTabKey, keyboardCellSelector, keyboardMultipleKeySelector, keyboardStateSelector, localStorageAvailable, mergeColTypes, mergeOptions, nextSortDirection, nillComparer, numberComparer, paginationReducer, paginationSelector, preferencePanelStateSelector, removeUndefinedProps, rowCountSelector, rowsLookupSelector, rowsStateSelector, scrollBarSizeSelector, scrollbarStateSelector, selectedRowsCountSelector, selectionStateSelector, setPageActionCreator, setPageSizeActionCreator, setPageSizeStateUpdate, setPageStateUpdate, setPaginationModeActionCreator, setRowCountActionCreator, setRowCountStateUpdate, sortColumnLookupSelector, sortModelSelector, sortedRowIdsSelector, sortedRowsSelector, stringNumberComparer, unorderedRowModelsSelector, useApi, useApiEventHandler, useApiMethod, useApiRef, useColumnMenu, useColumnReorder, useColumnResize, useColumns, useComponents, useContainerProps, useFilter, useGridApi, useGridReducer, useGridSelector, useGridState, useKeyboard, useLogger, useLoggerFactory, useNativeEventListener, usePagination, usePreferencesPanel, useRows, useScrollFn, useSelection, useSorting, useVirtualColumns, useVirtualRows, viewportSizeStateSelector, viewportSizesSelector, visibleColumnsLengthSelector, visibleColumnsSelector, visibleRowCountSelector, visibleRowsStateSelector, visibleSortedRowsSelector };
